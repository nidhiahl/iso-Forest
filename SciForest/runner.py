...
for run in range(1, runs+1): 
    ...
    os.system('./a.out '+dataset+' '+str(numTrees)+' '+str(samplingFactor)+' '+str(minSampleSize)+' '+str(numOfAttributes)+' '+str(numOfTrialsForHyperplane)+' >> results/'+dataset[10:-4]+'_result.csv')

    data = pd.read_csv('anomalyScores/'+dataset[10:-4]+'_attributes_taken_'+str(numOfAttributes)+'_hyperplanes_tested_'+str(numOfTrialsForHyperplane)+'.csv', delimiter=' ')
