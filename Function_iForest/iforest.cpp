...
iforest::iforest(const data & dataObject, const data & timeDataObject): _dataObject(dataObject), _timeDataObject(timeDataObject){}

iforest::iforest(const data & dataObject, int numiTrees, int sampleSize, double alpha, int dic_number, const data & timeDataObject):_dataObject(dataObject), _numiTrees(numiTrees), _sampleSize(sampleSize), _alpha(alpha), _dic_number(dic_number), _timeDataObject(timeDataObject){
