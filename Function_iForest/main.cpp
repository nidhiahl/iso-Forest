...
int main(int argc, char* argv[])
{
    ...
    const int dic_number = atoi(argv[6]);
    ...
    data *timeObject = new data();
    const data &timeDataObject = *timeObject;
    timeObject->createDataVector(timeFile);
	...
	iforest *iForestObject = new iforest(trainDataObject, numOfTrees, sampleSize, alpha, dic_number, timeDataObject);
