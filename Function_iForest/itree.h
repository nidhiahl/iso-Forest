...
{ 
    public:
        itree(const data &, const data &);									//used for: create an empty tree to load the itree from file and insert new points in data object
        itree(const data &,int, int, int, int, double, int, const data &);					//used for: create a tree using data object and initialize
        virtual ~itree();
