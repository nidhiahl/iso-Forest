...
class itree
{
    public:
		...
		long double computeAnomalyScore(int, const data &);						//compute PL = height of point + adjaustment for unbuilt tree below max.height
		vector<treenode *> hyperspheres;									//address of root node of the tree
    protected:
