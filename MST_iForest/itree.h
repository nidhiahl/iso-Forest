...
class itree
{
    public:
		...
		void computePathLengthAndNearestPointDistance(int, const data &, long double &, long double &);
        ...
        vector<long double> mean;                               //mean of samples constructing the iTree
        vector<long double> standard_dev;                       //standard deviation of samples constructing the iTree
        vector<treenode *> baseTrees;
    protected:
